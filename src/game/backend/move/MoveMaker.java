...
public class MoveMaker {
	...
	private void initMap(){
        ...
        map.put(new Candy().getKey() + new Nut().getKey(), new CandyMove(grid));
        ...
        map.put(new HorizontalStripedCandy().getKey() + new Nut().getKey(), new CandyMove(grid));
        ...
        map.put(new VerticalStripedCandy().getKey() + new Nut().getKey(), new CandyMove(grid));
        ...
        map.put(new WrappedCandy().getKey() + new Nut().getKey(), new CandyMove(grid));
		...
		// map.put(new Bomb().getKey() + new Cherry().getKey(), new BombMove(grid));
        // map.put(new Bomb().getKey() + new Nut().getKey(), new BombMove(grid));
        ...
        // map.put(new Cherry().getKey() + new Bomb().getKey(), new BombMove(grid));


        map.put(new Nut().getKey() + new Candy().getKey(), new CandyMove(grid));
        map.put(new Nut().getKey() + new HorizontalStripedCandy().getKey(), new CandyMove(grid));
        map.put(new Nut().getKey() + new VerticalStripedCandy().getKey(), new CandyMove(grid));
        map.put(new Nut().getKey() + new WrappedCandy().getKey(), new CandyMove(grid));
        // map.put(new Nut().getKey() + new Bomb().getKey(), new BombMove(grid));
	}
